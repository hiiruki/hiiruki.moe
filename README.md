...
| publishDate \*         | Again pretty simple. To change the date format/locale, currently **en-US**, update the date option in `src/site.config.ts`. Note you can also pass additional options to the component `<FormattedDate>` if required.                                                                                        |
