...
publishDate: "2023-09-29T11:40:41+07:00"
updatedDate: ""
coverImage:
...
![Monkey Components](./images/monkey_components.webp)
...
![Attack Diagram](./images/attack_diagram.webp)
...
![Download Infection Monkey](./images/step1.webp)
...
![Download Infection Monkey AppImage](./images/step1-2.webp)
...
![Make the AppImage executable](./images/step2.webp)
...
![Install FUSE 2.X](./images/step3-2.webp)

Docs: [Fuse Troubleshooting](https://docs.appimage.org/user-guide/troubleshooting/fuse.html)

:::note
If the error still occurs, you may need to redownload the AppImage it may be corrupted.
:::
...
![Run the AppImage](./images/step3-3.webp)
...
:::note
If you are using a self-signed certificate, you will get a warning message. Click on the Advanced button and then click on the Proceed to localhost (unsafe) link or click on the Accept the Risk and Continue button if you are using Firefox.
:::

![Browser Warning](./images/step4.webp)
...
![Start the Infection Monkey](./images/step7.webp)
...
![Start the Infection Monkey on Linux](./images/step7-2.webp)

Windows:

![Start the Infection Monkey on Windows](./images/step7-3.webp)

### 8. View the Infection Map

Go to the `Infection Map` section to view the Infection Map.

![View the Infection Map](./images/step8.webp)

![View the Infection Map](./images/step8-2.webp)
...
:::note
The Windows machine shown in the Infection Map is not part of the network. It is ther
:::
...
![View the Events](./images/step9.webp)
...
![IBM QRadar Community Edition](./images/step10.webp)
...
![View the Security Reports](./images/step11.webp)

![View the Security Reports](./images/step11-2.webp)
