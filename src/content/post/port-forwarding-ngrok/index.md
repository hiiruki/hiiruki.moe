...
publishDate: "2023-09-15T07:37:05+07:00"
updatedDate: ""
coverImage:
...
:::note
Install `wget` if it is not installed on your server. For Debian/Ubuntu, you can install it with `sudo apt install wget`. For CentOS/RHEL, you can install it with `sudo yum install wget`.
:::
...
![ngrok extract](./images/step2.webp "ngrok extract")
...
![ngrok version](./images/step2-2.webp "ngrok version")
...
![ngrok dashboard](./images/step3.webp "ngrok auth token")
...
![ngrok connect](./images/step4.webp "ngrok connect")
...
![ngrok start](./images/step5.webp "ngrok start")
...
:::note
The ngrok URL will change every time you start ngrok. So, you need to update the URL every time you start ngrok.
:::
