...
publishDate: "2023-09-16T17:09:14+07:00"
updatedDate: ""
# coverImage:
...
![hamburger menu](./images/step1.webp "hamburger menu")

- Click **Admin**

![admin](./images/step1-2.webp "admin menu")

- Or you can just click the **Admin** tab

![admin tab](./images/step1-3.webp "admin tab")

### 2. In the System Configuration section, click the System and License Management icon.

![system and license management](./images/step2.webp "system and license management")

### 3. From the Display menu, select Systems.

Select the relevant host

![systems](./images/step3.webp "systems")

### 4. From the Actions menu, select View and Manage System, and then click the System Time tab.

![system time](./images/step4.webp "system time")
...
![time zone](./images/step5.webp "time zone")
...
![set time manually](./images/step6.webp "set time manually")
...
![ntp servers](./images/step7.webp "ntp servers")

- The final result should look like this:

![ntp servers](./images/step7-2.webp "ntp servers")
...
![restart services](./images/step7-3.webp "restart services")

![restart services](./images/step7-4.webp "restart services")
