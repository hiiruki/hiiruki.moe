...
publishDate: "2024-08-22T00:08:31+07:00"
updatedDate: ""
coverImage:
...
```zsh showLineNumbers title=".zshrc"
# source antidote
...
```txt showLineNumbers title=".zsh_plugins.txt"
...
:::note
This is for the manual update for the static plugins
:::
...
```toml showLineNumbers title="starship.toml"
